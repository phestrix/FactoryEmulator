...
public class Dialogs {
    public static void showDefaultAlert(Stage root, String title, String message,
                                        Alert.AlertType type, String... header) {
    ...
    public static void showExceptionDialog(Stage root, Throwable ex, String... message) {
        ...
        alert.setHeaderText("Error occurred in application" + (message.length > 0 ? "\n" + message[0] : ""));
