...
public class Log {
    ...
    public static synchronized void init() throws Exception {
        ...
        InputStream input = Log.class.getResourceAsStream("log4j2.xml");
        ...
        info = LogManager.getLogger("log-info");//LogManager.getLogger("log-info");
    ...
    private static void appendMessage(StringBuilder message, String str, LogType type){
        message.append(str);
        switch (type) {
